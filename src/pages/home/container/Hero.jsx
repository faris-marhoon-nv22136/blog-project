  ...
  return (
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
      <div className="mt-10 lg:w-1/2">
        <h1 className="font-roboto text-3xl text-center font-bold text-dark-soft md:text-5xl lg:text-4xl lg:text-left xl: lg:max-w-[540px]">
      ...
      <div className="hidden lg:block lg:1/2">
        <img
          ...
          alt="users are reading articales"
        />
      </div>
    </section>
  );
